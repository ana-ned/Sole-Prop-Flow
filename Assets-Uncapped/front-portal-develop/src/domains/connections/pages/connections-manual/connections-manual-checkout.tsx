...
import { CheckoutConnectionControllerApi } from "../../../../services/api/connections"
...
const ManualConnectionCheckout = () => {
  ...
  const submitMutation = useMutation({
    mutationFn: async (formData: yup.InferType<typeof schema>) =>
      new CheckoutConnectionControllerApi(
        apiConfig({
          token: await getToken(),
          service: ApiServicesEnum.Connections,
        })
      ).addCheckoutConnection({
                    ...
                    <span>
                      <Trans
                        ...
                        components={{
                          ...
                          href: (
                            <a
                              href="https://hub.checkout.com/login"
                              target="_blank"
                              rel="noreferrer"
                            />
                          ),
...
export default ManualConnectionCheckout
